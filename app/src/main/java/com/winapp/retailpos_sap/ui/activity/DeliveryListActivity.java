...
public class DeliveryListActivity extends NavigationActivity implements View.OnClickListener {

    public RecyclerView deliveryListView;
    private LinearLayout transferInButton;
    private LinearLayout transferOutButton;
    public DeliveryListAdapter deliveryListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_delivery_list, contentFrameLayout);
        getSupportActionBar().setTitle("Delivery");
        dbHelper = new DBHelper(this);

        Log.w("activity_cg", getClass().getSimpleName().toString());

        deliveryListView = findViewById(R.id.rv_deliverylist);
        ...
        transferSearchText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (deliveryListAdapter != null) {
                    deliveryListAdapter.getFilter().filter(s.toString());
                }
            }
        });
...
//        });
    ...
    public void getDate(TextView dateTextView) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(DeliveryListActivity.this,
   ...
   //     try {
        ...
        Log.w("GivenTransferNo1::", "");

            deliveryListAdapter = new DeliveryListAdapter(this, transferList,
                    new DeliveryListAdapter.CallBack() {
                @Override
                public void callDescription(String transferNo, String mode) {
                    ...
                    if (mode.equals("Print")) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), DeliveryPreviewPrintActivity.class);
                        Log.w("DeliveryDetail1:","");
            ...
            deliveryListView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
            deliveryListView.setItemAnimator(new DefaultItemAnimator());
            deliveryListView.setAdapter(deliveryListAdapter);
...
//        }
    ...
    public void getTransferInRequest(String mode, String fromdate, String todate) {
        ...
        if (dialog != null && dialog.isShowing())
            dialog.cancel();
        dialog = new ProgressDialog(DeliveryListActivity.this);
