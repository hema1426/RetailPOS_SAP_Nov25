...
public class StockReqListDetailAdapter extends RecyclerView.Adapter<StockReqListDetailAdapter.ViewHolder> {

    private ArrayList<TransferDetailModel.TransferDetails> transferDetailsLists;
    private Context context;
    View view;
    private String printView;
    public StockReqListDetailAdapter(Context context, ArrayList<TransferDetailModel.TransferDetails> transferDetails, String printView) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.stockreq_detail_item, parent, false));
    }
