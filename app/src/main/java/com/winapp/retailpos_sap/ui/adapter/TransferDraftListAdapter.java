...
public class TransferDraftListAdapter extends RecyclerView.Adapter<TransferDraftListAdapter.TransferViewHolder> implements Filterable {
    /**
    ...
    public static class TransferViewHolder extends RecyclerView.ViewHolder {
      ...
      //  private final ProgressBar progressBar;
        ...
        public TransferViewHolder(View view) {
            ...
            status = view.findViewById(R.id.status_draft);
    ...
    public TransferViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.transfer_draft_list_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final TransferViewHolder holder, @SuppressLint("RecyclerView") final int position) {
      //  try {
            ...
            if (model.getStatus().equals("Open") || model.getStatus().equals("O")){
                ...
                holder.statusLayout.setBackgroundResource(R.drawable.invoice_status_paid);
//                ((UserViewHolder)viewHolder).indicator.setBackgroundResource(R.drawable.invoice_status_paid);
                ...
                holder.statusLayout.setBackgroundResource(R.drawable.invoice_closed);
//                ((UserViewHolder)viewHolder).indicator.setBackgroundResource(R.drawable.invoice_closed);
                holder.status.setText("Closed");
            }else {
                holder.statusLayout.setBackgroundResource(R.drawable.invoice_status_partial);
...
//        }
    ...
    private void getStockRequestDetails(String transferNo,RecyclerView.ViewHolder  viewHolder,
        ...
        jsonBody.put("DocNum",transferNo);
        RequestQueue requestQueue = Volley.newRequestQueue(mContext);
        String url= Constants.BASEURL +"InventoryTransferDraftDetails";
...
//            }
        ...
        ((TransferViewHolder) viewHolder).rv_stockReqList.setLayoutManager(new LinearLayoutManager(mContext,
            ...
            adapter = new TransferDraftListDetailAdapter(mContext, stockReqList, "");
